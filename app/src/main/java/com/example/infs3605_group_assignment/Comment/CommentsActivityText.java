...
public class CommentsActivityText extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_comments_text);

        // Remove action bar
        getSupportActionBar().hide();

        post_key = getIntent().getExtras().getString("postkey2"); // retrieve the text reference
        ...
        postref = FirebaseDatabase.getInstance().getReference().child("Uploads/Text").child(post_key).child("Comments");
        ...
        mBackBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CommentsActivityText.this, MyTexts.class);
...
//                        }
            ...
            private void commentFeature(String username) {
                ...
                if (comment_post.isEmpty()) {
                    Toast.makeText(CommentsActivityText.this, "Please write a comment", Toast.LENGTH_SHORT).show();
                } else {
                            ...
                            .addOnCompleteListener(new OnCompleteListener() {
                                ...
                                public void onComplete(@NonNull Task task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        Toast.makeText(CommentsActivityText.this, "Commented added!", Toast.LENGTH_SHORT).show();
                                    } else {
                                        Toast.makeText(CommentsActivityText.this, "Failed", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            })
